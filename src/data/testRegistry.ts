...
export const ALL_TESTS = [
  {
    ...
    highlight: "mapa claro de onde agir primeiro",
    icon: "🧠",
  ...
  },
  {
    ...
    highlight: "hipóteses ranqueadas por probabilidade",
    icon: "🔬",
    route: "/triagem",
  },
  {
    ...
    highlight: "por que você funciona diferente",
  ...
  },
  {
    ...
    highlight: "orientações práticas para apoiá-lo",
