  ...
  return (
    <div ref={resultRef} className="min-h-screen bg-background print:bg-white">
      ...
      <main className="max-w-2xl mx-auto px-5 pb-24 space-y-6">
        ...
        <div className="w-full max-w-md mx-auto mt-6 mb-4 rounded-2xl p-5 print:hidden" style={{ background: "linear-gradient(135deg, #2a3530, #1a2520)", border: "1px solid rgba(74,122,101,0.3)" }}>
          <h3 className="text-lg font-bold text-white mb-2">E agora?</h3>
          <p className="text-sm text-white/70 mb-4 leading-relaxed">
            Seu resultado é o começo. O próximo passo é entender por que funciona assim — com acompanhamento, testes aprofundados e trilhas guiadas feitas a partir de 3.000+ atendimentos.
          </p>
          <div className="flex flex-col gap-2">
            <a
              ...
              className="w-full py-3 rounded-xl text-center text-sm font-semibold text-white transition-all hover:scale-[1.02]"
              style={{ background: "#d4a574" }}
            >
              Assinar GiftedLab — R$348/ano
            </a>
            <a
              href="https://api.whatsapp.com/send/?phone=5547992513522&text=Oi%2C%20fiz%20o%20rastreio%20e%20quero%20saber%20sobre%20testagem&type=phone_number&app_absent=0"
              target="_blank"
              rel="noopener noreferrer"
              className="w-full py-3 rounded-xl text-center text-sm font-semibold transition-all hover:scale-[1.02]"
              style={{ background: "#4a7a65", color: "white" }}
            >
              Falar com a clínica
            </a>
          </div>
